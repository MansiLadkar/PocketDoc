...
function EditDoctors() {
  ...
  useEffect(() => {
    ...
    setGender(localStorage.getItem("Hospital_name"));
    setContact(localStorage.getItem("Address"));
    setDegree(localStorage.getItem("Booking_date"));
    setSpecialization(localStorage.getItem("Type"));
  });
