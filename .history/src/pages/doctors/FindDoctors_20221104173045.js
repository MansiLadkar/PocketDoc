...
function FindDoctors() {
 ...
 <TableBody>
          {DoctorData.map((item) => (
            <StyledTableRow key={item.DoctorData}>
              ...
              <StyledTableCell align="right">{item.Contact}</StyledTableCell>
              <StyledTableCell align="right">{item.Degree}</StyledTableCell>
              <StyledTableCell align="right">{item.Specialization}</StyledTableCell>
